...
bot.on('ready',async () => {
	...
	bot.user.setActivity('Mama lui Emanuelo',{type: "playing"});
	...
	switch(command){
		...
		case 'invite': {
		 let user = message.mentions.users.first() || message.author;
			...
			.setColor(color)
			.setTitle(`Invite NiLMERT to your discord server!`)
		...
		case 'addrole': {
		  ...
		  .addField("Example", "$addrole @NiLMER Member")
		...
		case 'removerole': {
		  ...
		  .addField("Example", "$removerole @NiLMERt Member")
